...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nested funtion can access the variable internal because it has access to the parent function as well as access to everything on the global scope... I think?
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(zooData){
    return zooData.reduce((accumulator, item) => accumulator + item.population, 0);
